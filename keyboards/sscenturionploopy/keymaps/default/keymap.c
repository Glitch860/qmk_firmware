...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        LSFT_T(KC_Z),  KC_X, KC_C,    KC_V,          KC_B,                      DRAG_SCROLL,            KC_N,          KC_M,          KC_COMMA, KC_DOT, RSFT_T(KC_SLSH),
                             KC_LGUI, LT(3,KC_DEL),  LT(1,KC_BSPC),                                     LT(1,KC_SPC),  LT(2,KC_ENT),  KC_LALT                        
    ),
    [_FN1] = LAYOUT(
        ...
        KC_LSFT, _______,  KC_MUTE, KC_VOLD, KC_VOLU,               _______,                  _______,  _______,  _______,  KC_RCTL, KC_RSFT,
