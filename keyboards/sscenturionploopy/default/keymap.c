...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        LCTRL_T(KC_A), KC_S, KC_D,    KC_F,          KC_G,                      KC_MS_BTN1,             KC_H,          KC_J,          KC_K,     KC_L,   RCTL_T(KC_SCLN),
        LSFT_T(KC_Z),  KC_X, KC_C,    KC_V,          KC_B,                      DRAG_SCROLL,            KC_N,          KC_M,          KC_COMMA, KC_DOT, RSFT_T(KC_SLSH),
                             KC_LGUI, LT(3,KC_SPC),  LT(1,KC_BSPC),                                     LT(1,KC_SPC),  LT(2,KC_ENT),  KC_LALT                        
    ),
    [_FN1] = LAYOUT(
        KC_TAB,   KC_HOME, KC_UP,   KC_END,   KC_PSCR,              _______,                  KC_BRIU,  KC_PGUP, KC_UP,   KC_PGDN,  KC_GRV,
        KC_LCTL,  KC_LEFT, KC_DOWN, KC_RIGHT, KC_INS,               _______,                  KC_BRID,  KC_LEFT, KC_DOWN, KC_RIGHT, KC_RCTL,
        KC_LSFT, _______,  KC_MUTE, KC_VOLD, KC_VOLU,               _______,                  _______,  ______,  _______,  _______, KC_RSFT,
                          _______, _______, _______,                                          _______, _______,  _______                   
    ),
    [_FN2] = LAYOUT(
        KC_ESC,  _______,   _______,  KC_LBRC,  KC_MINS,           _______,                   KC_EQL,  KC_RBRC, _______, _______, KC_DEL,
    ...
    [_FN3] = LAYOUT(
        ...
        RGB_VAD,  RGB_SAD,    RGB_HUD,    RGB_SPD,   RGB_RMOD,       _______,                   _______,  _______, _______, _______,  KC_F12,
                                    _______, _______, _______,                                  _______, _______,  _______                   
    )
};
